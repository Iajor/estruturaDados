/*Exercicio 2
crie um arquivo texto com n numero aleatorios, um abaixo do outro. Faça um programa que leia o arquivo e insira os números em uma pilha. Ao final, o programa deve mostrar o elemento no topo e o tamanho da pilha
*/
...
conectarBase(Pilha *topo){
    ifstream procuradorArquivo;
    procuradorArquivo.open("numeros.txt");
