/*Exercicio 1
Usando os códigos exemplos, refatore o de sua preferencia para gerar n numero aleatorios, contudo todo número par deve ser inserido na pilha. Todo número ímpar gerado deve remover um par do topo.
*/
